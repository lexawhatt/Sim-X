...
//!
//! Adapted from the previously reviewed Sim;X accumulator. Capacity and round-to-even
//! semantics are re-tested here independently of any archived world code.

use std::cmp::Ordering;

/// Largest input accepted by the shared accumulator.
pub(crate) const MAX_REPRODUCIBLE_SUM_INPUTS: usize = 2_048;

// 2,048 finite maximum values require fewer than 2,112 magnitude bits.
// The fixed 2,176-bit capacity includes eleven carry bits beyond any f64 input.
