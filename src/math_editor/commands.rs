...
impl MathState {
    pub(super) fn activate(&mut self, target: Target) {
        ...
        match target {
            ...
            Target::Copy => self.request_clipboard(super::clipboard::ClipboardAction::Copy),
            Target::Cut => self.request_clipboard(super::clipboard::ClipboardAction::Cut),
            Target::Paste => self.request_clipboard(super::clipboard::ClipboardAction::Paste),
            Target::Add => {
