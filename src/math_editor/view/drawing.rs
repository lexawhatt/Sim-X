...
use crate::math_editor::view::layout::Rect;
use sim_logic::prelude::*;
pub(in crate::math_editor) const BG: Color = Color::rgb(0.003347, 0.005182, 0.008568);
pub(in crate::math_editor) const PANEL: Color = Color::rgb(0.005605, 0.009134, 0.015209);
pub(in crate::math_editor) const INK: Color = Color::rgb(0.745404, 0.791298, 0.854993);
pub(in crate::math_editor) const MUTED: Color = Color::rgb(0.283149, 0.341914, 0.439657);
pub(in crate::math_editor) const ACCENT: Color = Color::rgb(0.450786, 0.381326, 0.930111);
pub(in crate::math_editor) const GEOMETRY: Color = Color::rgb(0.165132, 0.610496, 0.485150);

pub(in crate::math_editor) struct Line {
    pub from: [f32; 2],
    pub to: [f32; 2],
    pub color: Color,
    pub width: f32,
...
pub(in crate::math_editor) struct Text {
    pub text: String,
    pub position: [f32; 2],
    pub style: usize,
    pub color: Color,
...
pub(in crate::math_editor) struct Panel {
    pub rect: Rect,
    pub color: Color,
    pub depth: f32,
    pub radius: f32,
}
pub(in crate::math_editor) struct Dot {
    pub center: [f32; 2],
    pub radius: f32,
    pub color: Color,
    pub clip: Rect,
...
#[derive(Default)]
pub(in crate::math_editor) struct Scene {
    pub lines: Vec<Line>,
    pub texts: Vec<Text>,
...
pub(in crate::math_editor) fn clip_line(
    a: [f32; 2],
    b: [f32; 2],
    r: Rect,
) -> Option<([f32; 2], [f32; 2])> {
