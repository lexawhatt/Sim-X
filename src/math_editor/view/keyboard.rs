...
use crate::math_editor::view::layout::{Rect, Target};
pub(in crate::math_editor) fn numeric(
    controls: &mut Vec<(Target, Rect, &'static str)>,
    x: f32,
    top: f32,
) {
    let symbols = [
...
pub(in crate::math_editor) fn alphabet(
    controls: &mut Vec<(Target, Rect, &'static str)>,
    x: f32,
    top: f32,
) {
